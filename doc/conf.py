...
htmlhelp_basename = 'ConsoleCapturedoc'
...
latex_documents = [
    (master_doc, 'ConsoleCapture.tex', 'ConsoleCapture Documentation',
...
man_pages = [
    (master_doc, 'consolecapture', 'ConsoleCapture Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ConsoleCapture', 'ConsoleCapture Documentation',
     author, 'ConsoleCapture', 'One line description of project.',
     'Miscellaneous'),
]
